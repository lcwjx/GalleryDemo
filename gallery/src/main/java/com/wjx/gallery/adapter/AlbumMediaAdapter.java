...
import com.wjx.gallery.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.gallery_photo_capture_item, parent, false);
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View itemView) {
            super(itemView);
            mHint = itemView.findViewById(R.id.camera);
        }
    }
