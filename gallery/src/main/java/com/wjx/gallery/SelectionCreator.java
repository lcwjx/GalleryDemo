...
public final class SelectionCreator {
    private final GalleryFinal mGalleryFinal;
     ...
     *
     * @param galleryFinal a requester context wrapper.
     * @param mimeTypes    MIME type set to select.
     */
    SelectionCreator(GalleryFinal galleryFinal, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mGalleryFinal = galleryFinal;
    ...
    public SelectionCreator imageCrop(boolean isCrop) {
        mSelectionSpec.imageCrop = isCrop;
        return this;
    }
     ...
     * 图片裁剪是用的engine
     *
     * @param cropEngine {@link CropEngine}
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator cropEngine(CropEngine cropEngine) {
        mSelectionSpec.cropEngine = cropEngine;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        Activity activity = mGalleryFinal.getActivity();
        if (activity == null) {
            return;
        }
        ...
        Fragment fragment = mGalleryFinal.getFragment();
        if (fragment != null) {
